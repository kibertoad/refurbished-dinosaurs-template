...
Open research questions are in `queue/`, what can be done with the original
running is in `docs/RUNTIME.md`, live session requests are in
`docs/live-sessions/`, and `docs/HANDOVER.md` says where the last session
stopped.
